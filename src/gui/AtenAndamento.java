...
public class AtenAndamento extends javax.swing.JInternalFrame {

    DAOChamado daoc = new DAOChamado(EMF.geEntityManager());

    public AtenAndamento() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!chamado.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "Nenhum Chamado Em Andamento Encontrado.");
        }
