 ...
 * @author Maximiller
 */
public class TableModelAtendimentos extends AbstractTableModel {

    private List<Chamado> chamados;
    private String[] colunas = {"ID", "DESCRIÇÃO", "OBSERVAÇÃO", "DATA ABERTURA"};

    public TableModelAtendimentos() {
